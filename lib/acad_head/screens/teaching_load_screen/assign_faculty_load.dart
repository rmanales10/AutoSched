            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      Expanded(flex: 2, child: _rowText(facultyLoadData[0][0], true)), 
                      Expanded(flex: 3, child: _rowText(facultyLoadData[0][1], true)), 
                      Expanded(flex: 1, child: _rowText(facultyLoadData[0][2], true)), 
                      Expanded(flex: 1, child: _rowText(facultyLoadData[0][3], true)),
                      Expanded(flex: 1, child: _rowText(facultyLoadData[0][4], true)), 
                      Expanded(flex: 2, child: _rowText(facultyLoadData[0][5], true)), 
                      const SizedBox(width: 30),
                      Expanded(flex: 2, child: _rowText(facultyLoadData[0][6], true)), 
                    ],
                  ),
                ),
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      children: List.generate(
                        ...
                        (index) => _buildRow(facultyLoadData[index + 1], index + 1),
                      ),
                    ),
                  ),
                ),
