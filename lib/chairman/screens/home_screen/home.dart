                    ...
                    RichText(
                      text: TextSpan(
                        ...
                        children: [
                          TextSpan(
                            text: 'Auto',
                            style: TextStyle(fontSize: logoSize, color: const Color(0xFFFA9702)),
                          ),
                          TextSpan(
                            text: 'Sched',
                            style: TextStyle(fontSize: logoSize, color: const Color(0xFF010042)),
                          ),
                          WidgetSpan(
                            child: Transform.translate(
                              ...
                              child: Text(
                                '®',
                                style: TextStyle(fontSize: logoSize / 2, color: const Color(0xFFEB8D01)),
                              ),
                            ),
                          ),
                        ],
