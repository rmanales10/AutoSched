...
class EditCurriculumScreen extends StatefulWidget {
  const EditCurriculumScreen({super.key});

  @override
  _EditCurriculumScreenState createState() => _EditCurriculumScreenState();
}

class _EditCurriculumScreenState extends State<EditCurriculumScreen> {
